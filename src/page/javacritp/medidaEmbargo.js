const { jsPDF } = window.jspdf;
        ...
        async function generarmedidaEmbargo() {
            ...
            const TEXTO3 = `SEGUNDO: Que el contribuyente adeuda al Municipio de El Banco, Magdalena, la suma total de $ ${totalEmbargo} , correspondiente al Impuesto Predial Unificado, conforme al título ejecutivo constituido en el Mandamiento de Pago, en acto administrativo referenciado bajo el radicado ${numeroResolucionCoactivo} debidamente ejecutoriado.`;
